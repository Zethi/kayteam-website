          ...
          <SwiperSlide>
            <div className="flex justify-center py-4">
              <OpinionBox author="- ​LucasInDev, ​CrowtyCraft Network Owner -">
                Excellent production, execution and review by the team that makes up KayTeam, both @Segundo S.
                [Executive] and @Osvaldo P. [Technology] are very nice and pleasant people with whom you can talk and
                have a quiet laugh. The first time we worked with such nice devs who give a very good vibe.
              </OpinionBox>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="flex justify-center py-4">
              <OpinionBox author="- xUges_ -">
                ...
                [Technology] are quite professional people who can do what you asked in a few days and for a cheap
                price.
              </OpinionBox>
            </div>
          </SwiperSlide>
